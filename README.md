[![Build Status](https://dev.azure.com/user24-org/user24-devops/_apis/build/status/monolith-CI?branchName=master)](https://dev.azure.com/user24-org/user24-devops/_build/latest?definitionId=2&branchName=master)
